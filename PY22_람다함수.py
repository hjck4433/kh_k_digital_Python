...
# 람다 함수의 장점은 코드의 간결함, 메모리의 절약이라고 생각 할 수 있습니다.
# def add(a, b) :
#     return a + b
#
# print(add(1,2))
#
# print((lambda a,b: a+b)(1,2)) # 익명의 함수 / lambda라는 키워드를 사용했을 뿐
...
# map(함수, 리스트) : 리스트의 요소를 함수에 넣고 새로운 리스트를 구성해 주는 함수
...
out_ = list(map(lambda n: n * n,in_)) # n ** 2 도 같은 효과 # 함수 자리에 람다식으로 익명의 하수를 만들어 넣는 방법
print(out_)
